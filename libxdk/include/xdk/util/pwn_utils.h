...
/**
 * @ingroup util_classes
 * @brief Pins the calling thread to the provided CPU.
 *
 * @param cpu The CPU the calling thread should be pinned to. Defaults to 0 if unspecified.
 * @throws errno_error if the operation fails
 */
void pin_cpu(int cpu = 0);