...
public:
     ...
     * @throws ExpKitError if the system call fails or reads an unexpected number of bytes.
     */
     ...
     * @throws ExpKitError if the system call fails or writes an unexpected number of bytes.
     */
     ...
     * @param pipefds An array to hold the file descriptors for the read and write ends of the pipe.
     * @throws ExpKitError if the system call fails.
     */
